...
import com.example.foodapp_gt.Doman.FoodDoman;
import com.example.foodapp_gt.Helper.ManagementCart;
import com.example.foodapp_gt.Interface.ChangeNumberItemsListener;
...
public class CartAdaper extends RecyclerView.Adapter<CartAdaper.viewAdapterCart> {
    ...
    @Override
    public void onBindViewHolder(@NonNull viewAdapterCart holder, @SuppressLint("RecyclerView") int position) {
